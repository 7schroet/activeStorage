...
H5VL_as_rpc_t* H5VL_as_rpc_new_obj(void* under_obj, hid_t under_vol_id)
{
  ...
  new_obj = (H5VL_as_rpc_t*)malloc(sizeof(H5VL_as_rpc_t));
...
{
  auto o = (const H5VL_as_rpc_t*)obj;
...
herr_t H5VL_as_rpc_get_wrap_ctx(const void* obj, void** wrap_ctx)
{
  ...
  new_wrap_ctx = (H5VL_as_rpc_ctx_t*)malloc(sizeof(H5VL_as_rpc_ctx_t));
...
{
  auto wrap_ctx = (H5VL_as_rpc_ctx_t*)_wrap_ctx;
  ...
  if (under)
    new_obj = H5VL_as_rpc_new_obj(under, wrap_ctx->under_vol_id);
