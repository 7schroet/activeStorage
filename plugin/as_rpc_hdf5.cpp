...
static const H5VL_class_t H5VL_as_rpc_g = {
  ...
  .dataset_cls = {
    .create = H5VL_as_rpc_dset_create,
    .open = H5VL_as_rpc_dset_open,
    .read = H5VL_as_rpc_dset_read,
    .write = H5VL_as_rpc_dset_write,
    .get = H5VL_as_rpc_dset_get,
    .specific = H5VL_as_rpc_dset_specific,
    .optional = H5VL_as_rpc_dset_optional,
    .close = H5VL_as_rpc_dset_close,
   },
  .datatype_cls = {
    .commit = H5VL_as_rpc_dtype_commit,
    .open = H5VL_as_rpc_dtype_open,
    .get = H5VL_as_rpc_dtype_get,
    .specific = H5VL_as_rpc_dtype_specific,
    .optional = H5VL_as_rpc_dtype_optional,
    .close = H5VL_as_rpc_dtype_close,
  },
  .file_cls = {
    .create = nullptr,
    .open = nullptr,
